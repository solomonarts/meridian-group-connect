  ...
  return (
    <PortalShell email={me.profile?.email}>
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="text-xs font-semibold tracking-[0.25em] text-gold">DASHBOARD</div>
        <h1 className="mt-2 text-3xl font-bold">Welcome back{me.profile?.full_name ? `, ${me.profile.full_name}` : ""}.</h1>
